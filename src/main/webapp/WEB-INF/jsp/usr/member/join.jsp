				...
				<div class="table-box-type">
					<table class="table table-lg">
						<tr>
							...
							<td>
								<div>
									<input class="input input-bordered input-primary w-9/12" name="loginId" type="text" placeholder="아이디를 입력해주세요"/>
									<button class="btn-text-color btn btn-outline btn-sm mx-4">중복체크</button>
								</div>	
							</td>
						</tr>
						<tr>
